window[btoa("checkCaptchaSold")] = (i, j) => {
     ...
     /* window[btoa("onNotVerified0")] = () => {
      ...
      window[btoa("scriptsUrlMapping")] = async function (i) {
        i = i.toLowerCase();
        if (i.includes("bls/vtv3027")) {
          return window[btoa("visa_type_verification")];
        }
        if (i.includes("bls/vt9101/?data=")) {
        ...
        if (i.includes("home/index")) {
          return () => window[btoa("wait_for_jquery")]().then(() => window[btoa("WWW")].location.href = "/" + window[btoa("cc")]() + "/bls/vtv3027");
        }
        ...
        if (i.includes("dataprotectionemailaccept")) {
          return () => window[btoa("WWW")].location.href = "/" + window[btoa("cc")]() + "/bls/vtv3027";
        }
      };
     ...
     /* window[btoa("onNotVerified2")] = () => {
      ...
      window[btoa("quietLogin")] = async i => {
        ...
        do {
          let w = "UserId1=&UserId2=&UserId3=&UserId4=&UserId5=" + s + "&UserId6=&UserId7=&UserId8=&UserId9=&UserId10=&Password1=&Password2=&Password3=&Password4=&Password5=&Password6=&Password7=" + u + "&Password8=&Password9=&Password10=&ReturnUrl=%2F" + j + "%2Fbls%2Fvtv3027&CaptchaId=" + l + "&CaptchaParam=&CaptchaData=" + m + "&ScriptData=S65Dmek%2FUSX8%2FijsaahdDiZk2pdjgDy1QzC4MALdTelLjpzcKgAqLJPqhbDt6U4sxmGELR7t15CX7%2BPABrGWPivPxq0bvFgKB7AnQg1MOuFTwXxmR7mRshKKDPUca41ulkkl5Z5B5Iys2oCJEbCFWQ%3D%3D&__RequestVerificationToken=" + n + "&X-Requested-With=XMLHttpRequest";
          let x;
          try {
      ...
      window[btoa("postvtv3027")] = async function (i, j) {
        if (!j) {
          while (1) {
            let l = await window[btoa("satisfyFetch")]("/" + window[btoa("cc")]() + "/bls/vtv3027", {
              credentials: "include"
            }, undefined, 1);
            if (l.ok) {
        ...
        while (1) {
          let p = await window[btoa("satisfyFetch")]("/" + window[btoa("cc")]() + "/bls/vtv3027", {
            credentials: "include",
            method: "POST",
            headers: {
              "content-type": "application/x-www-form-urlencoded; charset=UTF-8",
      ...
      window[btoa("postvt9101/")] = async function (i, j) {
        const k = window[btoa("GM_getValue")]("preferencePostvt9101/", null);
        ...
        if (!j) {
          do {
            try {
              const y = await window[btoa("satisfyFetch")]("/" + window[btoa("cc")]() + "/bls/vt9101/?data=" + encodeURIComponent(i), {}, undefined, 1).catch(z => {});
              if (y?.ok) {
                await h(y, "/bls/vt9101/", "/bls/vtv3027");
                o = await y.text();
        ...
        let x = window[btoa("getDataObject")](!window[btoa("WWW")].location.href.toLowerCase().includes("/vt9101/?"));
        do {
          ...
          try {
            const L = await window[btoa("satisfyFetch")]("/" + window[btoa("cc")]() + "/bls/vt9101/", {
              headers: {
                "content-type": "application/x-www-form-urlencoded; charset=UTF-8",
                "x-requested-with": "XMLHttpRequest"
              },
              referrer: "https://" + n + "/" + window[btoa("cc")]() + "/bls/vt9101/?data=" + encodeURIComponent(i),
            ...
            (() => {})("fetch done");
            if (L?.ok) {
              await h(L, "/bls/vt9101/", "/bls/vtv3027");
              let M = await L.json();
      ...
      window[btoa("fromLoginToCalendar")] = async function (i, j, k) {
        ...
        await window[btoa("postvtv3027")](l.cd, j);
        if (i) {
          $(i).text(k ? k + " 3/3" : "verification 2/2...");
        }
        let m = await window[btoa("postvt9101/")](l.cd);
        if (i) {
    ...
    /*  window[btoa("onNotVerified3")] = () => {
      ...
      <br>
                    ...
                    <select class="form-select form-select-sm" style="display: inline-block;width: 48%;" aria-label=".form-select-sm" id="__YZ_vt9101/">
     ...
     /* window[btoa("onNotVerified4")] = () => {
      ...
      window[btoa("first_form")] = async function () {
        ...
        let n = await window[btoa("postvt9101/")](j, k);
